        ...
        <section id="sobre" className="px-4 py-20 bg-[hsl(210,20%,97%)] scroll-mt-20">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-4 leading-relaxed">
              O InnovaGO combina rigor metodológico, governança institucional e experiência real em projetos de pesquisa e inovação.
            </p>
            <div className="mt-12">
        ...
        <section id="contato" className="px-4 py-20 bg-[hsl(210,20%,97%)] scroll-mt-20">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Converse com nossos especialistas e descubra como o InnovaGO pode apoiar sua instituição.
            </p>
