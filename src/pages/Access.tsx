...
import logoSisConnectaWhite from "@/assets/logo-sisconnecta-white.png";
        ...
        <section id="sobre" className="px-4 py-20 bg-[hsl(210,20%,97%)] scroll-mt-20">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-4 leading-relaxed">
              O SisConnecta combina rigor metodológico, governança institucional e experiência real em projetos de pesquisa e inovação.
            </p>
            <div className="mt-12">
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button asChild variant="outline" size="lg" className="rounded-md px-8">
                <a href="mailto:contato@sisconnecta.com" className="inline-flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm">
                <li>
                  <a href="mailto:contato@sisconnecta.com" className="hover:text-white transition-colors inline-flex items-center gap-2">
                    <Mail className="h-3.5 w-3.5" />
                    contato@sisconnecta.com
                  </a>
                </li>
                <li>
                  <a href="https://sisconnecta.com/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-2">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm mb-6">
                <li>
                  <a href="https://www.instagram.com/sisconnecta" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-2">
                ...
                <li>
                  <a href="https://www.linkedin.com/company/sisconnecta" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-2">
          ...
          <div className="border-t border-white/10 pt-6 text-center text-sm text-gray-500">
            ...
            <a href="https://sisconnecta.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">
              sisconnecta.com
            </a>
            )
          </div>
