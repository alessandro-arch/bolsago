...
const pillars = [
  ...
  { icon: Users, title: "Experiência", description: "Desenvolvido pelo ICCA a partir de anos de atuação prática na execução e gestão de projetos de PD&I." },
];
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <span className="text-xl font-semibold text-foreground tracking-tight">SisConnecta</span>
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="w-72">
                <SheetHeader className="text-left border-b border-border pb-4 mb-4">
                  <SheetTitle>SisConnecta</SheetTitle>
                </SheetHeader>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12">
              <div className="bg-white rounded-xl border border-border p-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  A plataforma é uma iniciativa do <strong className="text-foreground">Instituto de Inovação, Conhecimento e Ciências Aplicadas (ICCA)</strong>, uma instituição privada, sem fins lucrativos, dedicada à pesquisa científica, tecnologia e inovação.
                </p>
                <a 
      ...
      <footer className="w-full bg-[hsl(220,20%,14%)] text-gray-300 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            {/* Col 1 - Brand */}
            <div>
              <span className="text-white font-semibold text-lg block mb-3">SisConnecta</span>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm">
                <li>
                  <a href="mailto:sisconnecta@icca.org.br" className="hover:text-white transition-colors inline-flex items-center gap-2">
                    <Mail className="h-3.5 w-3.5" />
                    sisconnecta@icca.org.br
                  </a>
                </li>
                <li>
                  <a href="https://icca.org.br/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-2">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm mb-6">
                <li>
                  <a href="https://www.instagram.com/icca.es" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-2">
                ...
                <li>
                  <a href="https://www.linkedin.com/company/instituto-capixaba-de-ci-ncias-e-administra-o/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-2">
              ...
              <ul className="space-y-2.5 text-sm">
                <li>
                  <a href="https://sisconnecta.com/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                    Site SisConnecta
                  </a>
                </li>
                <li>
                  <a href="https://icca.org.br/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                    Site ICCA
                  </a>
                </li>
              </ul>
