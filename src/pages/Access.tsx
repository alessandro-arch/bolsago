          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm mb-6">
                <li>
                  <a href="https://www.instagram.com/institutoicca/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-2">
                ...
                <li>
                  <a href="https://www.linkedin.com/company/instituto-icca/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-2">
