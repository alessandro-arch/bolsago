...
import { AlertCircle, Mail, Lock, Loader2, ArrowLeft, BarChart3 } from "lucide-react";
import { z } from "zod";
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <h1 className="text-xl font-bold text-foreground">Painel do Auditor</h1>
          </div>
        ...
        <Card className="shadow-lg border-border/50">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg">Acesse o Painel do Auditor</CardTitle>
            <CardDescription>Supervisão institucional em modo somente-leitura</CardDescription>
          </CardHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="auditor@instituicao.org"
                    value={email}
